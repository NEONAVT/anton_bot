...
from handlers.prices_web_app_data_handler import router as prices_web_app_router

__all__ = ["start_router", "about_router", "prices_router", "callback_web_app_router", "prices_web_app_router"]