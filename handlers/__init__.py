...
from handlers.services_handler import router as services_router
...
from handlers.projects_handler import router as projecs_router
from handlers.about import router as about_router

__all__ = ["start_router", "about_router", "prices_router", "web_app_data_router", "about_router"]